...
export default function AddSongPage( { setNewSongModal } ) {
  ...
  const validateCurrentStep = () => {
    if (currentStep === 0 && !newSongSheetMusic) {
      alert('Please upload the sheet music.');
      return false;
    }
    if (currentStep === 1 && !newSongTitle) { // Note: Step index is now 1 for song title
      alert('Please enter the song title.');
      return false;
    }
    if (currentStep === 2 && !newSongAudio) { // Note: Step index is now 2 for audio upload
            ...
            <main>
              <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div className="w-full">
                  {/* <div>Upload the SATB Sheet music.</div> */}
